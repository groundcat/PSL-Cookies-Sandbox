...
export default {
  async fetch(request) {
    ...
    // API: echo back the Cookie header the browser sent
    if (url.searchParams.get('action') === 'echo-cookies') {
      ...
      const parsed = cookieHeader
        ...
        : [];
      return new Response(JSON.stringify({ cookieHeader, parsed, hostname: url.hostname }), {
  ...
  <div class="col-12">
    <div class="card border-0 shadow-sm">
      <div class="card-header d-flex justify-content-between align-items-center">
        ...
        <small class="text-muted">(what the worker receives in the <code>Cookie</code> request header)</small>
      ...
      <div class="card-body">
        <p class="text-muted small mb-2">
          ...
          This panel makes a live fetch to the worker and shows exactly what the server receives —
            ...
            <div class="col-md-6">
              ...
              <ol>
                ...
                <li>
                  ...
                  even though they are served by the same worker.
                </li>
              </ol>
